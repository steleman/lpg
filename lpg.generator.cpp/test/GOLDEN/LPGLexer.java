...
public class LPGLexer extends Object implements RuleAction, ILexer
{
...
//*"\" starting at adjusted offset " + (affected_tokens.get(i).getStartOffset() + offset_adjustment));                           
    ...
    //
    //
    static class LPGLexerLpgLexStream extends LpgLexStream
    {
    ...
    public LPGLexerLpgLexStream(String filename, int tab) throws java.io.IOException
    {
        super(filename, tab);
    }

    public LPGLexerLpgLexStream(char[] input_chars, String filename, int tab)
    {
        super(input_chars, filename, tab);
    }

    public LPGLexerLpgLexStream(char[] input_chars, String filename)
    {
