...
import java.util.Set;
    ...
    //#line 159 "dtParserTemplateF.gi

public class LPGParser extends Object implements RuleAction, IParser
{
    ...
    static public abstract class AbstractASTNodeList extends ASTNode implements IAbstractArrayList<ASTNode>
    {
         ...
         *
         */
        public boolean add(ASTNode element)
        {
            addElement(element);
            return true;
        }
        ...
        private class Itr implements java.util.Iterator<ASTNode> {
            java.util.Iterator<ASTNode> itr = list.iterator();
        ...
        private class ListItr extends Itr implements java.util.ListIterator<ASTNode> {
            java.util.ListIterator<ASTNode> list_itr;
            ListItr(int index) {
            ...
            public void set(ASTNode o) {
                throw new UnsupportedOperationException();
            }
            public void add(ASTNode o) {
                throw new UnsupportedOperationException();
            }
        }
        ...
        public java.util.List<ASTNode> subList(int fromIndex, int toIndex) {
