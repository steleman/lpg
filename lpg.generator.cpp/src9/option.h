...
public:
    ...
    void Emit(Token *, const char *, TextBuffer &);
    void Emit(Token *, Token *, const char *, const char *);
    void Emit(Token *, Token *, const char *, TextBuffer &);
    void EmitError(int, const char *);
    void EmitError(int, TextBuffer &);
    void EmitWarning(int, const char *);
    void EmitWarning(int, TextBuffer &);
    void EmitInformative(int, const char *);
    void EmitInformative(int, TextBuffer &);

    void EmitError(Token *token, const char *msg)       { Emit(token, "Error: ", msg); return_code = 12; }
    void EmitError(Token *token, TextBuffer &msg)       { Emit(token, "Error: ", msg); return_code = 12; }
    void EmitWarning(Token *token, const char *msg)     { Emit(token, "Warning: ", msg); }
    void EmitWarning(Token *token, TextBuffer &msg)     { Emit(token, "Warning: ", msg); }
    void EmitInformative(Token *token, const char *msg) { Emit(token, "Informative: ", msg); }
    void EmitInformative(Token *token, TextBuffer &msg) { Emit(token, "Informative: ", msg); }

    void EmitError(Token *startToken, Token *endToken, const char *msg)       { Emit(startToken, endToken, "Error: ", msg); return_code = 12; }
    void EmitError(Token *startToken, Token *endToken, TextBuffer &msg)       { Emit(startToken, endToken, "Error: ", msg); return_code = 12; }
    void EmitWarning(Token *startToken, Token *endToken, const char *msg)     { Emit(startToken, endToken, "Warning: ", msg); }
    void EmitWarning(Token *startToken, Token *endToken, TextBuffer &msg)     { Emit(startToken, endToken, "Warning: ", msg); }
    void EmitInformative(Token *startToken, Token *endToken, const char *msg) { Emit(startToken, endToken, "Informative: ", msg); }
    void EmitInformative(Token *startToken, Token *endToken, TextBuffer &msg) { Emit(startToken, endToken, "Informative: ", msg); }
