...
//
void XmlTable::OutputTables(void)
{
    ...
    tab_buffer.Put(dfa -> num_states, 5);
    ...
    if (option -> error_maps)
    {
        ...
        tab_buffer.Put(produce -> scope_prefix.Size(), 4);
        tab_buffer.Put(produce -> scope_right_side.Size() - 1, 4);
        tab_buffer.Put(produce -> scope_state.Size() - 1, 4);
        tab_buffer.Put(produce -> num_error_rules, 4);
        tab_buffer.Put('\n');
