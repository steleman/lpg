...
public:
    ...
    void ProcessCompressionAndGeneration(void);
    TextBuffer &GetReport() { return report; }
    void Generate(Table *);

    Generator(Control *control_) : control(control_),
                                   ...
                                   new_state_element(control_ -> pda -> max_la_state + 1),
                                   shift_on_error_symbol(control_ -> pda -> max_la_state + 1, false),
                                   next(12, 256),
                                   previous(12, 256)
