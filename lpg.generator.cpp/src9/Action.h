...
protected:
    ...
    //
    // Check whether or not the filename starts with a directory prefix that matches one of the
...
public:
    ...
    void EmitMacroError(const char *, const char *, const char *, TextBuffer &);
    void EmitMacroWarning(const char *, const char *, const char *, TextBuffer &);
...
protected:
     ...
     */
public:
    virtual void ProcessCodeActions(Tuple<ActionBlockElement> &, Array<const char *> &, Tuple< Tuple<ProcessedRuleElement> > &) = 0;
