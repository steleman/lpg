...
void Grammar::Process()
{
    ...
    this -> action = (option -> programming_language == Option::C
                          ? new CAction(control, action_blocks, this, macro_table)
                          : (option -> programming_language == Option::CPP
                                 ? new CppAction(control, action_blocks, this, macro_table)
                                 : (option -> programming_language == Option::JAVA
                                        ? new JavaAction(control, action_blocks, this, macro_table)
                                        : (option -> programming_language == Option::PLX
                                               ? new PlxAction(control, action_blocks, this, macro_table)
                                               : (option -> programming_language == Option::PLXASM
                                                      ? new PlxasmAction(control, action_blocks, this, macro_table)
                                                      : (option -> programming_language == Option::ML
                                                             ? new MlAction(control, action_blocks, this, macro_table)
                                                             : (Action *) new XmlAction(control, action_blocks, this, macro_table)))))));
