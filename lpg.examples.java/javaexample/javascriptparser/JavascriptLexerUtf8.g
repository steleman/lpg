...
%options template=Utf8LexerTemplateD.g
%options filter=JavascriptKWLexerUtf8.g
...
$Define
    ...
    $super_stream_class /.Utf8LexStream./
...
$Headers
    /.
                             ...
                             ParseTable parse_table)
        {
            ...
            byte [] input_bytes = getInputBytes();
            if (input_bytes == null)
...
$Headers
    /.
        ...
        public $action_type(String filename) throws java.io.IOException
        {
            ...
            this.kwLexer = new $kw_lexer_class(getInputBytes(), $_IDENTIFIER);
        }
        ...
        public void initialize(byte [] content, String filename)
        {
            ...
            if (this.kwLexer == null)
                 this.kwLexer = new $kw_lexer_class(getInputBytes(), $_IDENTIFIER);
            else this.kwLexer.setInputBytes(getInputBytes());
        }
        ...
        {
            return (i >= buffer.length ? Char_EOF : tokenKind[getUnicodeValue(i)]);
        }
