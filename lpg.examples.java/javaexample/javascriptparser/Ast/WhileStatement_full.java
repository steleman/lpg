...
/**
 *<b>
 *<li>Rule 287:  WhileStatement_full ::= WHILE ParenListExpression Substatement_full
 *</b>
 */
public class WhileStatement_full extends Ast implements IWhileStatement_full
{
    ...
    public WhileStatement_full(IToken leftIToken, IToken rightIToken,
                               AstToken _WHILE,
    ...
    public boolean equals(Object o)
    {
        ...
        //
        if (! (o instanceof WhileStatement_full)) return false;
        WhileStatement_full other = (WhileStatement_full) o;
