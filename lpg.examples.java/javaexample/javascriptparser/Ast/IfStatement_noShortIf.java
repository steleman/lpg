...
/**
 *<b>
 *<li>Rule 271:  IfStatement_noShortIf ::= IF ParenListExpression Substatement_noShortIf ELSE Substatement_noShortIf
 *</b>
 */
public class IfStatement_noShortIf extends Ast implements IIfStatement_noShortIf
{
    ...
    private ISubstatement_noShortIf _Substatement_noShortIf5;
    ...
    public ISubstatement_noShortIf getSubstatement_noShortIf5() { return _Substatement_noShortIf5; }

    public IfStatement_noShortIf(IToken leftIToken, IToken rightIToken,
                                 AstToken _IF,
                                 IParenListExpression _ParenListExpression,
                                 ISubstatement_noShortIf _Substatement_noShortIf,
                                 AstToken _ELSE,
                                 ISubstatement_noShortIf _Substatement_noShortIf5)
    {
        ...
        this._ELSE = _ELSE;
        this._Substatement_noShortIf5 = _Substatement_noShortIf5;
        initialize();
    }
    ...
    public boolean equals(Object o)
    {
        ...
        //
        if (! (o instanceof IfStatement_noShortIf)) return false;
        IfStatement_noShortIf other = (IfStatement_noShortIf) o;
        ...
        if (! _Substatement_noShortIf5.equals(other._Substatement_noShortIf5)) return false;
        return true;
    }
    ...
    public int hashCode()
    {
        ...
        hash = hash * 31 + (_Substatement_noShortIf5.hashCode());
        return hash;
    }
    ...
    public void enter(Visitor v)
    {
        ...
        if (checkChildren)
        {
            ...
            _ELSE.accept(v);
            _Substatement_noShortIf5.accept(v);
        }
        v.endVisit(this);
    }
}
