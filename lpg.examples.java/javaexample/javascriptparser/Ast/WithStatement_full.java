...
/**
 *<b>
 *<li>Rule 305:  WithStatement_full ::= WITH ParenListExpression Substatement_full
 *</b>
 */
public class WithStatement_full extends Ast implements IWithStatement_full
{
    ...
    public WithStatement_full(IToken leftIToken, IToken rightIToken,
                              AstToken _WITH,
    ...
    public boolean equals(Object o)
    {
        ...
        //
        if (! (o instanceof WithStatement_full)) return false;
        WithStatement_full other = (WithStatement_full) o;
