...
{
    private static ParseTable prs = new JavascriptLexerprs();
    ...
    public JavascriptLexer(String filename, int tab) throws java.io.IOException 
    {
        super(filename, tab);
    }

    public JavascriptLexer(char[] input_chars, String filename, int tab)
    {
        super(input_chars, filename, tab);
    }

    public JavascriptLexer(char[] input_chars, String filename)
    {
    ...
    public String[] orderedExportedSymbols() { return JavascriptParsersym.orderedTerminalSymbols; }
    public ILexStream getLexStream() { return (ILexStream) this; }
                ...
                input_chars[char_index + 1] != '/')
            {
                ...
                if (parser.parse(sym, 0) != ERROR_ACTION)
                {
                    prsStream.makeToken(char_index,
                                        (sym[0] == TK_SLASH ? char_index : char_index + 1),
                                        sym[0]);
                    char_index += (sym[0] == TK_SLASH ? 1 : 2);
                }
            }
    ...
    //
    JavascriptKWLexer kwLexer;
    private final static int ECLIPSE_TAB_VALUE = 4;

    public int [] getKeywordKinds() { return kwLexer.getKeywordKinds(); }

    public JavascriptLexer(String filename) throws java.io.IOException
    {
        this(filename, ECLIPSE_TAB_VALUE);
        this.kwLexer = new JavascriptKWLexer(getInputChars(), TK_IDENTIFIER);
    }
    ...
    //
    //
    public JavascriptLexer(Option option) throws java.io.IOException
    {
    ...
    public void ruleAction(int ruleNumber)
    {
        switch(ruleNumber)
        {
            ...
            //
            // Rule 35:  NextInputElement ::= WhiteSpace
            //
            case 35: { 
                skipToken();
                break;
            ...
            //
            // Rule 36:  NextInputElement ::= IdentifierOrKeyword
            //
            case 36: { 
                checkForKeyWord();
                break;
            ...
            //
            // Rule 38:  NextInputElement ::= NumericLiteral
            //
            case 38: { 
                makeToken(TK_Number);
                break;
            ...
            //
            // Rule 39:  NextInputElement ::= StringLiteral
            //
            case 39: { 
                makeToken(TK_String);
                break;
            ...
            //
            // Rule 40:  NextInputElement ::= RegExpLiteral
            //
            case 40: { 
                makeToken(TK_RegularExpression);
                break;
            }
     
            //
            // Rule 41:  NextInputElement ::= LineComment
            //
            case 41: { 
            ...
            //
            // Rule 42:  NextInputElement ::= BlockComment
            //
            case 42: { 
            ...
            //
            case 107: { 
                makeToken(TK_EQUAL_EQUAL_EQUAL);
                break;
            }
