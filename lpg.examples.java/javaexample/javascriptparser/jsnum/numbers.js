 ...
 * precede any numeric literal (as well as any identifier or keyword).  So
 * digits at the start of a line (or at the start of other scanned regions)
 * will be seen as "unexpected" characters and will not be recognized.  This
 * includes digits that immediately follow a punctuation mark (unless they
 * are part of a larger element that is recognized as a number).  To avoid
 * problems with this, except for a test case at the beginning of this file,
 * the test cases here are generally indented by some amount of whitespace. 
 */


// 12345	Regular integer at the start of a line
12345
