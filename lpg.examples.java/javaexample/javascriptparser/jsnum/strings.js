...
/*
 * A variety of strings with correct and incorrect punctuation.
 *
 * Note:  the NextInputElementNum rule requires (in effect) that whitespace
 * precede any keyword, identifier, or numeric literal.  So any of these
 * elements that begin a line (other other scanned regions) will be seen
 * to include "unexpected" characters and will not be recognized.  This
 * includes characters or digits that immediately follow a punctuation mark
 * (unless they are part of a larger element that is being recognized).  As
 * a consequence, the results of this test should be carefully evaluated in
 * light of this perhaps unexpected but apparently indicated behavior.
*/
