 ...
 * BUT the RegularExpression lexer will not properly recognize
 * the various division operators used here, so it's scan will
 * contain errors and unrecognized elements.
 */
