...
public class ExprParser extends PrsStream implements RuleAction
{
    ...
    public void ruleAction(int ruleNumber)
    {
        switch (ruleNumber)
        {
            ...
            case 1: {
                setResult(
                    new E(ExprParser.this, getLeftIToken(), getRightIToken(),
                          (IE)getRhsSym(1),
                          (IT)getRhsSym(3))
                );
                break;
            ...
            case 3: {
                setResult(
                    new T(ExprParser.this, getLeftIToken(), getRightIToken(),
                          (IT)getRhsSym(1),
                          (IF)getRhsSym(3))
                );
                break;
            ...
            case 5: {
                setResult(
                    new F(ExprParser.this, getRhsIToken(1))
                );
                break;
            } 
            //
            ...
            case 6: {
                setResult(
                    new ParenExpr(ExprParser.this, getLeftIToken(), getRightIToken(),
                                  (IE)getRhsSym(2))
                );
                break;
            }
